...
const NavBar = () => {
  return (
    <nav className="flex border-b-[1px] border-black-800 object-contain h-[100px] items-center">
      ...
      <div className=" border-black border-[2px] px-[10px] text-[18px] ml-[10%] font-semibold cursor-pointer">Let's Chat</div>
    </nav>
  );
};
